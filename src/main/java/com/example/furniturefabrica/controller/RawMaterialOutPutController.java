...
import com.example.furniturefabrica.service.RawMaterialOutPutService;
...
@Controller
@RequestMapping("/api/rawMaterialOutPut")
public class RawMaterialOutPutController {


    @Autowired
    RawMaterialOutPutService rawMaterialOutPutService;
